...
from omni.isaac.orbit_assets.unitree import UNITREE_A1_CFG, UNITREE_GO1_CFG, UNITREE_GO2_CFG, WIDOW_GO1_CFG, ALIENGO_Z1_CFG  # isort:skip
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # Origin 8 with Unitree Aliengo + Z1
    prim_utils.create_prim("/World/Origin8", "Xform", translation=origins[7])
    aliengo_z1 = Articulation(ALIENGO_Z1_CFG.replace(prim_path="/World/Origin8/Robot"))
