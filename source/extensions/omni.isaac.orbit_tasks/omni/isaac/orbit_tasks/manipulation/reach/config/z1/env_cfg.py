...
# Pre-defined configs
##
from omni.isaac.orbit_assets import UNITREE_Z1_CFG  # isort: skip
...
@configclass
class Z1ReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

        # switch robot to ur10
        self.scene.robot = UNITREE_Z1_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class Z1ReachEnvCfg_PLAY(Z1ReachEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
