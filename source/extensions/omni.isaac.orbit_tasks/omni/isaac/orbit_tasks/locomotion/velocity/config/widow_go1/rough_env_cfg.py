...
# Pre-defined configs
##
from omni.isaac.orbit_assets.unitree import WIDOW_GO1_CFG  # isort: skip


@configclass
class WidowGo1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
...
@configclass
class WidowGo1RoughEnvCfg_PLAY(WidowGo1RoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
